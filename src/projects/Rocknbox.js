...
import RockFull from "./../img/web/rocknbox-fullSite.jpg"
    ...
    render={data => (
      <div className="portfolio">
        <ul className="portfolio__headerTitle">
          ...
          <li>
            <WebLink link="http://rocknbox-rg.netlify.com" />
          </li>
        </ul>
        <div className="portfolio__website">
          <ul className="portfolio__website-container">
            <li className="portfolio__website-container--fullWidth">
              ...
              <PortfolioOverlay>
                Mock-up subscription service that caters to music collectors and
                fans of Rock'n'Roll.
              </PortfolioOverlay>
              ...
              /> */}
              <img src={RockFull} alt="Rocknbox" className="dropShadow" />
            </li>
          </ul>
        </div>
      </div>
