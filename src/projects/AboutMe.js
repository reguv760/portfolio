      ...
      <div className="portfolio">
        ...
        <div className="portfolio__aboutMe">
          <div className="row">
            ...
            <p>Elit eu velit in et id ea ut consectetur cillum sit cupidatat et pariatur nisi velit esse labore quis exercitation. Veniam dolor laborum commodo consequat veniam aliquip do irure et velit consequat reprehenderit aute in aute qui nisi laboris labore esse ullamco voluptate est anim sunt.</p>
            </div>
          </div>
