  ...
  <aside className="sidebar">
    ...
    <nav>
      <ul className="sidebar__nav">
        <li>
          <Link to="/" className="active_link">Projects</Link>
        </li>
        <li>
          <a href="./reggiegalang-resume18.pdf" target="_blank" rel="noopener noreferrer">R&eacute;sum&eacute;</a>
        </li>
      </ul>
    </nav>
    ...
    <div className="sidebar__footer">
      <ul className="socialmedia">
        ...
        <li>
          <a href="https://github.com/reguv760/" target="_blank" className="svg"  rel="noopener noreferrer">
